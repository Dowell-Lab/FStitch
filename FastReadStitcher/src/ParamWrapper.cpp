...
void ParamWrapper::printUsage()
{
    ...
    printf("following:\n");
    printf(" -r <read bedgraph>   This specifies the file containing reads.\n");
    ...
    printf("                      generated with ChIPseq.\n");
    //TODO: rewrite the following:
    printf(" -cm <number>         This sets the maximum number of iterations for learning.\n");
    printf(" -ct <number>         This sets the convergence threshold.\n");
    //CHANGED FROM -al
    printf(" -lr <number>         This sets the learning rate.\n");
    printf(" -reg <number>        This sets some kind of regularization parameter.\n");
    printf(" -ms <number>         This sets the maximum seed value.\n");
    ...
    printf(" --posfile <file> This specifies the training data for the positive strand.\n");
    ...
    printf(" --negfile <file> This specifies the training data for the negative strand.\n");
    ...
    printf(" --onfile <file>  This specifies the training data marking all \"on\"\n");
    printf("                  regions. It is a bed3 file formatted as follows:\n");
    printf("                  chromosome[tab]start[tab]stop\n");
    printf(" --offfile <file> This specifies the training data marking all \"off\"\n");
    printf("                  regions. It follows the same format as --onfile.\n");
    printf(" -a <file>        This specifies an annotations file containing information\n");
    ...
    printf("following:\n");
    printf(" --strand <+/-/both>    This specifies whether to segment based on information\n");
...
ParamWrapper::ParamWrapper(int argc, char **argv)
{
    ...
    for(it=paramMap.begin();it!=paramMap.end();it++)
    {
        ...
        else if(it->first=="--offfile")
        {
            this->secondSpecialFileName=it->second;
        }
        
        else if(it->first=="--onfile")
        {
            this->specialFileName=it->second;
            this->specialFileSplit=true;
        }
        
        else if(it->first=="--negfile")
        {
            this->secondSpecialFileName=it->second;
        }
        
        else if(it->first=="--posfile")
        {
            this->specialFileName=it->second;
            this->specialFileSplit=true;
        }
